...
import { n as csrfSymbol, t as createCsrfMiddleware } from "./createCsrfMiddleware-J6t9AYq7.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BlGO7MV9.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C8DpKB6G.mjs"),
		import("./start-DHFsIWB6.mjs"),
