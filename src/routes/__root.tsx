...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Little Gems Academy" },
      { property: "og:title", content: "Little Gems Academy — Primary School Portal" },
      {
    ...
    links: [
      ...
      { rel: "icon", href: "/little-gems-logo.png", type: "image/png" },
      { rel: "apple-touch-icon", href: "/little-gems-logo.png" },
    ],
  }),
