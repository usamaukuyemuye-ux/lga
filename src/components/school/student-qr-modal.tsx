            ...
            >
                  ...
                  <div className="flex items-center gap-2.5">
                    {student.photo_url ? (
                      <img
                        ...
                        className="size-11 rounded-lg object-cover border border-slate-300 shadow-xs shrink-0"
                      />
                    ) : (
                      <div className="size-11 rounded-lg bg-slate-100 text-slate-800 flex items-center justify-center font-bold text-sm border border-slate-300 shrink-0">
              ...
              <div className="bg-slate-100 px-4 py-2 border-t border-slate-200 flex items-center justify-between text-[9px] text-slate-600 print:bg-slate-100">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>Verified Little Gems Academy Credential</span>
                </div>
                        ...
                        <div className="flex items-center gap-2">
                          {student.photo_url ? (
                            <img
                              src={student.photo_url}
                              alt={student.full_name}
                              className="size-7 rounded-full object-cover border border-slate-300 shadow-xs shrink-0"
                            />
                          ) : (
                            <div className="size-7 rounded-full bg-slate-200 text-slate-700 flex items-center justify-center font-bold text-xs shrink-0">
                              {student.full_name.charAt(0)}
                            </div>
                          )}
